...
let githubLink = "http://github.com/rogeralsing/Beacon"

// Specify more information about your project
let info =
  [ "project-name", "Beacon"
    "project-author", "Roger Johansson"
    "project-summary", "HTTP Service Discovery"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Beacon" ]
